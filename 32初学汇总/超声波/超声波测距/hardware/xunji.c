...
//C0、C1、C2andc6(定点)
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_1| GPIO_Pin_2| GPIO_Pin_6; //定义红外引脚
...
void run()
{
		TIM_SetCompare1(TIM3,140);
   		TIM_SetCompare2(TIM3,135);
		TIM_SetCompare3(TIM3,135);
   		TIM_SetCompare4(TIM3,140);
		AIN1 =1;
		AIN2 =0; 
		AIN3 =1;
		AIN4 =0;
